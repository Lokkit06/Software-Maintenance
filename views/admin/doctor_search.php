...
if(isset($_POST['doctor_search_submit']))
{
    try {
      ...
      if(!$result){
        throw new Exception('Doctor search query failed');
      }
    ...
    <table class='table table-hover'>
      ...
      <tbody>";
    	...
    	// }
    	echo "</tbody></table><center><a href='dashboard.php' class='btn btn-light'>Back to dashboard</a></div></center></div></div></div>";
    }
      }
      catch (Throwable $e) {
        error_log('doctor_search failed: ' . $e->getMessage());
