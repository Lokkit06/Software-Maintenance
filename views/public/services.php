...
<section id="intro" class="intro"  style="font-family: 'IBM Plex Sans', sans-serif;">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                <img src="../../assets/img/dummy/img-1.png" class="img-responsive" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <div class="wow fadeInLeft" data-wow-delay="0.2s">
              <img src="../../assets/img/dummy/img-6.png" class="img-responsive" alt="" />
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
  ...
  <script src="../../assets/js/js/jquery.scrollTo.js"></script>
  <script src="../../assets/js/js/jquery.appear.js"></script>
  <script src="../../assets/js/js/stellar.js"></script>
  ...
  <script src="../../assets/js/js/nivo-lightbox.min.js"></script>
